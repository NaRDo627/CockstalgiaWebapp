package net.hkpark.cockstalgiacore.core.aspect;

import com.fasterxml.jackson.core.JsonProcessingException;
import lombok.extern.slf4j.Slf4j;
import net.hkpark.cockstalgiacore.core.util.JsonUtil;
...
public class ArgumentLoggerAspect {
    @Pointcut("@annotation(net.hkpark.cockstalgiacore.core.annotation.PrintArguments)")
